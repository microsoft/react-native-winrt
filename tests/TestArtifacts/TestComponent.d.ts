...
declare namespace TestComponent {
    ...
    interface ITest {
        ...
        appendZeroToIVectorAsync(vector: Windows.Foundation.Collections.IVector<number>): Windows.Foundation.IAsyncAction;
        fillZeroesToIVectorAsync(vector: Windows.Foundation.Collections.IVector<number>): Windows.Foundation.IAsyncActionWithProgress<number>;
        createIVectorAsync(): Windows.Foundation.IAsyncOperation<Windows.Foundation.Collections.IVector<number>>;
        createIVectorWithZeroesAsync(): Windows.Foundation.IAsyncOperationWithProgress<Windows.Foundation.Collections.IVector<number>, number>;
        createAsyncException(): Windows.Foundation.IAsyncAction;
