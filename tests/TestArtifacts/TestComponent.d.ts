...
declare namespace TestComponent {
    ...
    class Test {
        ...
        static staticU8Property: number;
        static staticU64Property: number;
        static staticU32Property: number;
        static staticU16Property: number;
        static staticStringsStructProperty: TestComponent.StringTypes;
        static staticStringProperty: string;
        static staticStringArrayProperty: string[];
        static staticS64Property: number;
        static staticS32Property: number;
        static staticS16Property: number;
        static staticRefNumericProperty: number | null;
        static staticRefEnumProperty: TestComponent.TestEnum | null;
        static staticRefCharProperty: string | null;
        static staticRefBooleanProperty: boolean | null;
        static staticRefArrayProperty: number[] | null;
        static staticObjectProperty: TestComponent.TestObject;
        static staticObjectArrayProperty: TestComponent.TestObject[];
        static staticNumericsStructProperty: TestComponent.NumericTypes;
        static staticNumericArrayProperty: number[];
        static staticGuidProperty: string;
        static staticGuidArrayProperty: string[];
        static staticF64Property: number;
        static staticF32Property: number;
        static staticEnumProperty: TestComponent.TestEnum;
        static staticEnumArrayProperty: TestComponent.TestEnum[];
        static staticCompositeStructProperty: TestComponent.CompositeType;
        static staticCompositeStructArrayProperty: TestComponent.CompositeType[];
        static staticCharProperty: string;
        static staticCharArrayProperty: string[];
        static staticBooleansStructProperty: TestComponent.BooleanTypes;
        static staticBooleanArrayProperty: boolean[];
        ...
        static makeObservableVector(): Windows.Foundation.Collections.IObservableVector<number>;
        static makeObservableMap(): Windows.Foundation.Collections.IObservableMap<string, number>;
        ...
        static returnSameBoolVectorView(vector: Windows.Foundation.Collections.IVectorView<boolean>): Windows.Foundation.Collections.IVectorView<boolean>;
        static returnSameCharVectorView(vector: Windows.Foundation.Collections.IVectorView<string>): Windows.Foundation.Collections.IVectorView<string>;
        static returnSameNumericVectorView(vector: Windows.Foundation.Collections.IVectorView<number>): Windows.Foundation.Collections.IVectorView<number>;
        static returnSameStringVectorView(vector: Windows.Foundation.Collections.IVectorView<string>): Windows.Foundation.Collections.IVectorView<string>;
        static returnSameGuidVectorView(vector: Windows.Foundation.Collections.IVectorView<string>): Windows.Foundation.Collections.IVectorView<string>;
        static returnSameEnumVectorView(vector: Windows.Foundation.Collections.IVectorView<TestComponent.TestEnum>): Windows.Foundation.Collections.IVectorView<TestComponent.TestEnum>;
        static returnSameCompositeStructVectorView(vector: Windows.Foundation.Collections.IVectorView<TestComponent.CompositeType>): Windows.Foundation.Collections.IVectorView<TestComponent.CompositeType>;
        static returnSameRefVectorView(vector: Windows.Foundation.Collections.IVectorView<number | null>): Windows.Foundation.Collections.IVectorView<number | null>;
        static returnSameObjectVectorView(vector: Windows.Foundation.Collections.IVectorView<TestComponent.TestObject>): Windows.Foundation.Collections.IVectorView<TestComponent.TestObject>;
        static returnSameBoolIterable(iterable: Windows.Foundation.Collections.IIterable<boolean>): Windows.Foundation.Collections.IIterable<boolean>;
        static returnSameCharIterable(iterable: Windows.Foundation.Collections.IIterable<string>): Windows.Foundation.Collections.IIterable<string>;
        static returnSameNumericIterable(iterable: Windows.Foundation.Collections.IIterable<number>): Windows.Foundation.Collections.IIterable<number>;
        static returnSameStringIterable(iterable: Windows.Foundation.Collections.IIterable<string>): Windows.Foundation.Collections.IIterable<string>;
        static returnSameGuidIterable(iterable: Windows.Foundation.Collections.IIterable<string>): Windows.Foundation.Collections.IIterable<string>;
        static returnSameEnumIterable(iterable: Windows.Foundation.Collections.IIterable<TestComponent.TestEnum>): Windows.Foundation.Collections.IIterable<TestComponent.TestEnum>;
        static returnSameCompositeStructIterable(iterable: Windows.Foundation.Collections.IIterable<TestComponent.CompositeType>): Windows.Foundation.Collections.IIterable<TestComponent.CompositeType>;
        static returnSameRefIterable(iterable: Windows.Foundation.Collections.IIterable<number | null>): Windows.Foundation.Collections.IIterable<number | null>;
        static returnSameObjectIterable(iterable: Windows.Foundation.Collections.IIterable<TestComponent.TestObject>): Windows.Foundation.Collections.IIterable<TestComponent.TestObject>;
