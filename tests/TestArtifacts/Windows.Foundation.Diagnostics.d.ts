...
declare namespace Windows.Foundation.Diagnostics {
    ...
    class LoggingFields {
        ...
        addTimeSpan(name: string, value: number, format: Windows.Foundation.Diagnostics.LoggingFieldFormat): void;
        addTimeSpan(name: string, value: number, format: Windows.Foundation.Diagnostics.LoggingFieldFormat, tags: number): void;
        addTimeSpanArray(name: string, value: number[]): void;
        addTimeSpanArray(name: string, value: number[], format: Windows.Foundation.Diagnostics.LoggingFieldFormat): void;
        addTimeSpanArray(name: string, value: number[], format: Windows.Foundation.Diagnostics.LoggingFieldFormat, tags: number): void;
