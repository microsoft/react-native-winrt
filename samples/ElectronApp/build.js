...
const nugetPackages = [
  { id: 'Microsoft.Windows.CppWinRT', version: '2.0.240405.15' },
  { id: 'Microsoft.Windows.SDK.BuildTools', version: '10.0.26100.1742' },
  { id: 'Microsoft.WindowsAppSDK', version: '1.7.250127003-experimental3' },
  { id: 'Microsoft.Windows.ImplementationLibrary', version: '1.0.240803.1' },
  { id: 'Microsoft.Windows.SDK.BuildTools', version: '10.0.26100.1742' },
  { id: 'Microsoft.Windows.SDK.CPP', version: '10.0.26100.3323' },
  { id: 'Microsoft.Windows.SDK.CPP.x64', version: '10.0.26100.3323' },
  { id: 'Microsoft.Windows.SDK.CPP.arm64', version: '10.0.26100.3323' },
  { id: 'Microsoft.Web.WebView2', version: '1.0.2903.40' },
];
...
function nugetRestore() {
  ...
  for (const pkg of nugetPackages) {
    if (!fs.existsSync(getPackagePath(pkg.id))) {
      console.log(`Restoring NuGet package: ${pkg.id} ${pkg.version}`);
      runCommand(`"${nugetPath}" install ${pkg.id} -Version ${pkg.version} -OutputDirectory ${nugetPkgDir}`);
    } else {
      console.log(`NuGet package already exists: ${pkg.id} ${pkg.version}`);
    }
  }*/
