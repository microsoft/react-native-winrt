...
std::string GetValueToNativeConverter(FileWriter& write, const winmd::reader::TypeSig& typeSig, bool isInout, std::map<std::string, std::vector<winmd::reader::TypeSig>>* specializedInterfaceReferences);