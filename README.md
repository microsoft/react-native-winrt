...
The versioning scheme for React Native WinRT aligns with versions of React Native Windows. A new major version of React Native Windows is not guaranteed to be supported by a lower version of React Native WinRT. For example, a React Native Windows 0.67 app may not be compatible with **Microsoft.ReactNative.WinRT** 0.66.* package versions due to potential breaking changes.
